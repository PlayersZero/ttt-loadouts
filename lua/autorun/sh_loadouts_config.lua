...
loadouts.printloadout = "[CURRENT LOADOUT]: "
loadouts.loadoutupdated = "Loadout updated! You will receive it when the round starts!"
...
loadouts.version = "0.02"
loadouts.lastupdated = "12/30/2019 (MM/DD/YYYY)"
loadouts.whitelist = {"supporter", "tttsupporter", "vip", "tttvip", "admin", "senioradmin", "superadmin"}
loadouts.debug = false // Are we debugging shit or is it fucking working?
...
loadouts.icons = {
	...
	["weapon_zm_molotov"] = "vgui/ttt/loadout_icon_molotov",
	["weapon_ttt_confgrenade"] = "vgui/ttt/loadout_icon_discombob",
	["weapon_ttt_smokegrenade"] = "vgui/ttt/loadout_icon_smoke",
}
